...
public class Main {
    ...
    public static void main(String[] args) throws PulsarClientException, InterruptedException {
        ...
        SenderOptions<String> senderOptions = SenderOptions.create(Map.of("topicName", "topic5"), Schema.STRING);
        PulsarSender<String> sender = PulsarSender.create(client, senderOptions);

        Flux<PulsarRecord<String>> recordFlux = Flux.just(
        ...
        Consumer<String> consumer = pc.newConsumer(Schema.STRING)
                .topic("topic5")
